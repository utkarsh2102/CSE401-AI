\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Lab8\_KnapsackProblem\_BruteForce\_And\_DynamicProgramming}
...
\begin{document}
    ...
    Lab8: Implement a Knapsack problem using Brute Force Method and Dynamic
Programming
...
The total execution time taken is 0.0247344970703125.
    ...
    Implement a Knapsack problem using Dynamic Programming. Compare the
